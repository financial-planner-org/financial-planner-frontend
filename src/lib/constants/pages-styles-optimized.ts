...
export const ALLOCATIONS_STYLES = {
    timeline: {
        ...
        line: `${POSITION_COMMON.absolute} left-4 sm:left-6 top-10 sm:top-12 ${PROJECT_SPECIFIC.w0_5} ${SIZE_COMMON.hFull} bg-gray-600`,
...
export const PROJECTIONS_STYLES = {
    ...
    projections: {
        ...
        current: {
            ...
            badge: `${PROJECT_SPECIFIC.w10} ${PROJECT_SPECIFIC.h8} p-2.5 ${BG_COMMON.blue500_25} ${BORDER_COMMON.rounded} ${LAYOUT_CLASSES.flexCenter} gap-2.5`,
            badgeText: `${TEXT_COMMON.accent} ${TEXT_COMMON.workSans}`,
            bar: `${PROJECT_SPECIFIC.w96} ${PROJECT_SPECIFIC.h16} ${BG_COMMON.indigo500_30} ${BORDER_COMMON.roundedMd}`,
            barFill: `${PROJECT_SPECIFIC.w28} ${PROJECT_SPECIFIC.h16} ${BG_COMMON.gradientBlue} ${BORDER_COMMON.roundedMd}`
        },
        future: {
            ...
            percentage: `${TEXT_COMMON.accent} ${TEXT_COMMON.workSans}`,
            bar: `${PROJECT_SPECIFIC.w96} ${PROJECT_SPECIFIC.h16} ${BG_COMMON.zinc900} ${BORDER_COMMON.roundedMd}`
        },
        retirement: {
    ...
    scenarioStatus: {
        ...
        radio: `${PROJECT_SPECIFIC.w8} ${PROJECT_SPECIFIC.h8} ${BORDER_COMMON.roundedFull} ${BORDER_COMMON.solid2} border-neutral-400`,
        label: `${TEXT_COMMON.bodyMuted} ${TEXT_COMMON.neuton}`
    },
    
    chart: {
        container: `${PROJECT_SPECIFIC.w1413} ${PROJECT_SPECIFIC.h96} ${POSITION_COMMON.absolute} ${PROJECT_SPECIFIC.left101} ${PROJECT_SPECIFIC.top540} ${BG_COMMON.zinc900} ${PROJECT_SPECIFIC.rounded32}`,
        ...
        yAxis: {
            container: `${POSITION_COMMON.absolute} left-[20px] top-[60px] ${SPACING.space.y[4]}`,
        ...
        dots: {
            amber: `${PROJECT_SPECIFIC.w4} ${PROJECT_SPECIFIC.h3} bg-amber-300 ${BORDER_COMMON.roundedFull} ${POSITION_COMMON.absolute}`
        }
    },
    ...
    simulationControls: {
        ...
        button: {
            container: `${PROJECT_SPECIFIC.w72} ${PROJECT_SPECIFIC.h16} ${BG_COMMON.zinc900} ${PROJECT_SPECIFIC.rounded2xl} ${LAYOUT_CLASSES.flexCenter} gap-4 px-4`,
            selected: `${PROJECT_SPECIFIC.w72} ${PROJECT_SPECIFIC.h16} ${BG_COMMON.zinc900} ${PROJECT_SPECIFIC.rounded2xl} outline outline-2 outline-blue-400 ${LAYOUT_CLASSES.flexCenter} gap-4 px-4`,
            radio: `${PROJECT_SPECIFIC.w8} ${PROJECT_SPECIFIC.h8} ${BORDER_COMMON.roundedFull} ${BORDER_COMMON.solid2} border-zinc-800`,
            radioSelected: `${PROJECT_SPECIFIC.w8} ${PROJECT_SPECIFIC.h8} ${BORDER_COMMON.roundedFull} ${BORDER_COMMON.solid2} border-blue-400`,
            radioFill: `${PROJECT_SPECIFIC.w6} ${PROJECT_SPECIFIC.h6} ${BG_COMMON.zinc800} ${BORDER_COMMON.roundedFull}`,
            radioFillSelected: `${PROJECT_SPECIFIC.w6} ${PROJECT_SPECIFIC.h6} ${BG_COMMON.blue500} ${BORDER_COMMON.roundedFull}`,
            text: `${PROJECT_SPECIFIC.cinzaClaro} ${TEXT_COMMON.workSans}`,
            dots: `${PROJECT_SPECIFIC.w1} ${PROJECT_SPECIFIC.h1} bg-zinc-300 ${BORDER_COMMON.roundedFull}`
        },
        addButton: {
            container: `${PROJECT_SPECIFIC.w28} ${PROJECT_SPECIFIC.h16} ${BG_COMMON.zinc900} ${PROJECT_SPECIFIC.rounded2xl} outline outline-2 outline-amber-300 ${LAYOUT_CLASSES.flexCenter}`,
            text: `${PROJECT_SPECIFIC.cinzaClaro} ${TEXT_COMMON.workSans}`
        }
    },
    ...
    timeline: {
        ...
        salary: {
            ...
            dot: `${PROJECT_SPECIFIC.w3} ${PROJECT_SPECIFIC.h4} ${BG_COMMON.green500} ${BORDER_COMMON.roundedFull} ${POSITION_COMMON.absolute}`,
            line: `${PROJECT_SPECIFIC.w6} h-0 origin-top-left rotate-90 ${BG_COMMON.green500} outline outline-1 outline-offset-[-0.50px] outline-cinza-média ${POSITION_COMMON.absolute}`
        },
        costOfLiving: {
            container: `${POSITION_COMMON.absolute} ${PROJECT_SPECIFIC.top140}`,
            label: `${PROJECT_SPECIFIC.custoDeVida} ${TEXT_COMMON.workSans}`,
            value: `${PROJECT_SPECIFIC.custoDeVida} ${TEXT_COMMON.workSans}`,
            dot: `${PROJECT_SPECIFIC.w3} ${PROJECT_SPECIFIC.h4} bg-custo-de-vida ${BORDER_COMMON.roundedFull} ${POSITION_COMMON.absolute}`,
            line: `${PROJECT_SPECIFIC.w6} h-0 origin-top-left rotate-90 bg-custo-de-vida outline outline-1 outline-offset-[-0.50px] outline-cinza-média ${POSITION_COMMON.absolute}`
        },
    ...
    movements: {
        ...
        tabs: {
            ...
            active: `${PROJECT_SPECIFIC.w72} px-6 py-3 bg-gray-200 ${PROJECT_SPECIFIC.rounded47} ${LAYOUT_CLASSES.flexCenter} gap-2`,
            inactive: `${PROJECT_SPECIFIC.w72} px-6 py-3 ${BG_COMMON.zinc900} ${PROJECT_SPECIFIC.rounded47} ${LAYOUT_CLASSES.flexCenter} gap-2`,
        ...
        cards: {
            ...
            card: `${PROJECT_SPECIFIC.w697} ${PROJECT_SPECIFIC.h44} ${BG_COMMON.zinc900} ${PROJECT_SPECIFIC.rounded2xl} border-2 border-Plano-original p-6 ${POSITION_COMMON.relative}`,
            ...
            icon: {
                credit: `${PROJECT_SPECIFIC.w6} ${PROJECT_SPECIFIC.h6} ${BG_COMMON.green700} ${POSITION_COMMON.absolute}`,
                debit: `${PROJECT_SPECIFIC.w6} ${PROJECT_SPECIFIC.h6} ${BG_COMMON.red500} ${POSITION_COMMON.absolute} origin-top-left -rotate-180`
            }
        }
    },
...
export const HISTORY_STYLES = {
    mainContainer: `${PROJECT_SPECIFIC.w1413} ${PROJECT_SPECIFIC.h1108} ${POSITION_COMMON.relative} ${BG_COMMON.zinc950} ${PROJECT_SPECIFIC.rounded3xl} overflow-hidden`,
    
    userHeader: {
        container: `${PROJECT_SPECIFIC.w96} ${PROJECT_SPECIFIC.h16} ${BG_COMMON.zinc950} ${PROJECT_SPECIFIC.rounded32} border-2 border-cinza-claro ${POSITION_COMMON.relative}`,
        name: `${TEXT_COMMON.primary} ${TEXT_COMMON.h1} ${TEXT_COMMON.workSans} ${POSITION_COMMON.absolute} left-[18px] top-[18px]`,
        dropdown: `${PROJECT_SPECIFIC.w8} ${PROJECT_SPECIFIC.h4} ${POSITION_COMMON.absolute} right-[15px] top-[25px] outline outline-4 outline-offset-[-2px] outline-cinza-claro`
    },
    ...
    table: {
        ...
        header: {
            container: `${PROJECT_SPECIFIC.w1272} ${PROJECT_SPECIFIC.h16} ${LAYOUT_CLASSES.flexCenter} border-b border-neutral-600`,
        ...
        row: {
            container: `${PROJECT_SPECIFIC.w1272} ${PROJECT_SPECIFIC.h24} border-b border-neutral-600 ${LAYOUT_CLASSES.flexCenter}`,
    ...
    simulationCards: {
        container: `${POSITION_COMMON.absolute} ${PROJECT_SPECIFIC.left163} ${PROJECT_SPECIFIC.top385} ${SPACING.space.y[4]}`,
        card: {
            container: `${PROJECT_SPECIFIC.w1272} ${PROJECT_SPECIFIC.h64} bg-transparent ${PROJECT_SPECIFIC.rounded20} border border-neutral-600 ${POSITION_COMMON.relative}`,
            smallCard: `${PROJECT_SPECIFIC.w1272} ${PROJECT_SPECIFIC.h24} bg-transparent ${PROJECT_SPECIFIC.rounded20} border border-neutral-600 ${POSITION_COMMON.relative}`,
            icon: {
                container: `${PROJECT_SPECIFIC.w12} ${PROJECT_SPECIFIC.h12} ${POSITION_COMMON.absolute} left-[29px] top-[21px] ${BORDER_COMMON.roundedFull}`,
                blur: `${PROJECT_SPECIFIC.w12} ${PROJECT_SPECIFIC.h12} ${POSITION_COMMON.absolute} ${BORDER_COMMON.roundedFull} blur`,
                gradient: `${PROJECT_SPECIFIC.w12} ${PROJECT_SPECIFIC.h12} ${POSITION_COMMON.absolute} ${BORDER_COMMON.roundedFull}`,
                small: `${PROJECT_SPECIFIC.w11} ${PROJECT_SPECIFIC.h11} ${POSITION_COMMON.absolute} left-[76px] top-[68px] ${BORDER_COMMON.roundedFull}`,
                highlight: `${PROJECT_SPECIFIC.w6} ${PROJECT_SPECIFIC.h6} ${POSITION_COMMON.absolute} ${BORDER_COMMON.roundedFull} outline outline-1 outline-offset-[-0.50px] outline-neutral-100 blur-[2.50px]`,
                highlightClean: `${PROJECT_SPECIFIC.w6} ${PROJECT_SPECIFIC.h6} ${POSITION_COMMON.absolute} ${BORDER_COMMON.roundedFull} outline outline-1 outline-offset-[-0.50px] outline-neutral-100`
            },
            title: `${TEXT_COMMON.zinc300} ${TEXT_COMMON.h3} ${TEXT_COMMON.neuton} ${POSITION_COMMON.absolute} left-[98px] top-[21px]`,
            button: {
                container: `${PROJECT_SPECIFIC.w72} ${PROJECT_SPECIFIC.h12} px-6 py-3 ${BG_COMMON.neutral700} ${PROJECT_SPECIFIC.rounded47} ${LAYOUT_CLASSES.flexCenter} gap-2.5 ${POSITION_COMMON.absolute} right-[29px] top-[21px]`,
    ...
    pagination: {
        ...
        button: {
            container: `${PROJECT_SPECIFIC.w10} ${PROJECT_SPECIFIC.h10} ${BG_COMMON.zinc800} ${PROJECT_SPECIFIC.rounded3xl} border border-neutral-700 ${LAYOUT_CLASSES.flexCenter}`,
            icon: `${PROJECT_SPECIFIC.w8} ${PROJECT_SPECIFIC.h8}`,
            prev: `w-0 ${PROJECT_SPECIFIC.h4} ${BG_COMMON.neutral500}`,
            next: `${PROJECT_SPECIFIC.w3} ${PROJECT_SPECIFIC.h4} ${BG_COMMON.white}`
        }
    },
    ...
    sidebar: {
        ...
        logo: {
            container: `${PROJECT_SPECIFIC.w40} ${PROJECT_SPECIFIC.h12} ${BG_COMMON.gradientOrange} ${PROJECT_SPECIFIC.rounded47} border border-orange-600 ${LAYOUT_CLASSES.flexCenter}`,
            image: `${PROJECT_SPECIFIC.w24} ${PROJECT_SPECIFIC.h10}`
        },
        menu: {
            container: `${SPACING.space.y[2]} mt-8`,
            item: {
                container: `${PROJECT_SPECIFIC.w72} px-6 py-3 ${PROJECT_SPECIFIC.rounded47} ${LAYOUT_CLASSES.flexStart} gap-2`,
                active: `${PROJECT_SPECIFIC.w72} ${PROJECT_SPECIFIC.h14} px-6 py-3 ${BG_COMMON.zinc800} ${PROJECT_SPECIFIC.rounded47}`,
                icon: `${PROJECT_SPECIFIC.w6} ${PROJECT_SPECIFIC.h6} ${BG_COMMON.zinc300}`,
                smallIcon: `${PROJECT_SPECIFIC.w6} ${PROJECT_SPECIFIC.h6}`,
                text: `${TEXT_COMMON.bodyMuted} ${TEXT_COMMON.workSans}`,
...
export const COMMON_STYLES = {
    ...
    flexCenterGap4: `${LAYOUT_CLASSES.flexCenter} ${SPACING.gap[4]}`,
    flexGap1: `${LAYOUT_CLASSES.flexCenter} ${SPACING.gap[1]}`,
    ...
    iconMedium: `${PROJECT_SPECIFIC.w4} ${PROJECT_SPECIFIC.h4} mr-1`,
    iconLarge: `${PROJECT_SPECIFIC.w6} ${PROJECT_SPECIFIC.h6} ${PROJECT_SPECIFIC.cinzaClaro}`,
    ...
    // Cards de simulação
    simulationCards: `${SPACING.space.y[4]} mt-4`,
    ...
    // Sidebar decorativo
    sidebarDots: `${PROJECT_SPECIFIC.w2} ${PROJECT_SPECIFIC.h2} outline outline-[1.50px] outline-offset-[-0.75px] outline-neutral-500`,
    sidebarDotsSmall: `${PROJECT_SPECIFIC.w2} ${PROJECT_SPECIFIC.h1} outline outline-[1.50px] outline-offset-[-0.75px] outline-neutral-500`,
    sidebarIcon: `${PROJECT_SPECIFIC.w4} ${PROJECT_SPECIFIC.h4} ${BG_COMMON.neutral400}`,
    sidebarIconActive: `${PROJECT_SPECIFIC.w6} ${PROJECT_SPECIFIC.h4} ${BG_COMMON.zinc300}`,
    sidebarIconInactive: `${PROJECT_SPECIFIC.w6} ${PROJECT_SPECIFIC.h4} ${BG_COMMON.neutral500}`,
    
    // Barras decorativas
    decorativeBar: `${PROJECT_SPECIFIC.w72} ${PROJECT_SPECIFIC.h16} left-[-310px] ${PROJECT_SPECIFIC.top1072} ${POSITION_COMMON.absolute} ${BG_COMMON.gradientStone} ${BORDER_COMMON.roundedXl} border border-neutral-100`,
    ...
    userAvatar: `${PROJECT_SPECIFIC.w8} ${PROJECT_SPECIFIC.h8} left-[-296px] ${PROJECT_SPECIFIC.top1072} ${POSITION_COMMON.absolute} ${BG_COMMON.red400} ${BORDER_COMMON.roundedLg}`,
    ...
    decorativeBarSmall: `${PROJECT_SPECIFIC.w20} ${PROJECT_SPECIFIC.h2} left-[-177px] ${PROJECT_SPECIFIC.top59} ${POSITION_COMMON.absolute} opacity-70 ${BG_COMMON.red500} blur`,
    decorativeBarTiny: `${PROJECT_SPECIFIC.w12} ${PROJECT_SPECIFIC.h2} left-[-162px] ${PROJECT_SPECIFIC.top59} ${POSITION_COMMON.absolute} opacity-70 bg-gray-200/50 blur-[2.50px]`,
    decorativeBarVertical: `${PROJECT_SPECIFIC.w1} ${PROJECT_SPECIFIC.h16} left-[1839px] ${PROJECT_SPECIFIC.top140} ${POSITION_COMMON.absolute} ${BG_COMMON.blue500} ${BORDER_COMMON.roundedLg}`
} as const;
