...
export const SIDEBAR_CONFIG = {
    // Container principal
    mainContainer: 'responsive-sidebar h-[1083px] relative bg-stone-950 rounded-3xl overflow-hidden',
    ...
    // Menu
    menuContainer: 'absolute left-[44px] top-[170px] space-y-2 w-full max-w-[calc(100%-88px)]',
    menuContainerMobile: 'absolute left-[44px] top-[30px] space-y-2 w-full max-w-[calc(100%-88px)]',
    menuItem: 'w-full max-w-60 px-6 py-2 rounded-[47px] inline-flex justify-start items-center gap-2 cursor-pointer hover:bg-neutral-800 transition-colors',
    subMenuItem: 'ml-4',
    iconContainer: 'w-6 h-6 flex items-center justify-center flex-shrink-0',
    textContainer: 'flex-1 justify-start text-xl font-medium font-[\'Work_Sans\'] leading-loose truncate',
    ...
    mobileSheetContent: 'responsive-sidebar p-0 border-none bg-stone-950',
    ...
    // Desktop
    desktopSidebar: 'fixed left-0 top-0 z-50 h-screen responsive-sidebar bg-stone-950 border-r border-neutral-700'
} as const;
