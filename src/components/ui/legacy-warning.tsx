          ...
          <div className='max-w-xs'>
            {isCurrentSituation ? (
              <p>
                ...
                <br />
                Esta simulação não pode ser editada ou deletada. Ela representa o estado atual do
                patrimônio.
              </p>
            ) : (
              <p>
                <strong>Versão Legada:</strong>
                <br />
                Esta é uma versão antiga e não pode ser editada. Você pode criar uma nova simulação
