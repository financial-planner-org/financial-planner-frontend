          ...
          <Table>
            <TableHeader>
              <TableRow>
                ...
                {!showWithoutInsurances && <TableHead className='text-right'>Seguros</TableHead>}
              ...
              {displayYears.map((year, index) => {
                ...
                return (
                  <TableRow key={year}>
                    ...
                    <TableCell className='text-right'>{formatCurrency(financialValue)}</TableCell>
                    <TableCell className='text-right'>{formatCurrency(realEstateValue)}</TableCell>
                    {!showWithoutInsurances && (
                      <TableCell className='text-right'>{formatCurrency(insuranceValue)}</TableCell>
                    )}
