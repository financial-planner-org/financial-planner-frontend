...
export function useCreateAllocation() {
  ...
  return useMutation({
    mutationFn: (data: CreateAllocationInput) => allocationsApiService.createAllocation(data),
    onSuccess: data => {
...
export function useUpdateAllocation() {
  ...
  return useMutation({
    mutationFn: (data: UpdateAllocationInput) => {
      const { id, ...updateData } = data;
      return allocationsApiService.updateAllocation(id, updateData);
    },
    onSuccess: data => {
...
export function useCreateAssetRecord() {
  ...
  return useMutation({
    mutationFn: (data: CreateAssetRecordInput) =>
      allocationsApiService.addAllocationRecord(data.allocationId, data),
    onSuccess: data => {
      // Invalidar queries relacionadas
      queryClient.invalidateQueries({
